...
## Introduction
In this case study, I will perform real-world tasks as junior data analyst for a fictional bike sharing company called Cyclistic. To answer the key business questions, I will follow the steps of data analysis process: [Ask](https://github.com/wifaqmn/cyclistic-case-study/blob/main/README.md#ask)
### Quick links:
